      ...
      <style>
        ...
        * {
        ...
        .play-btn {
            ...
            min-width: 30px;
            height: 30px;
            background: url("icons/audio-player-icon-sprite.png") 0 center/500% 100% no-repeat;
            appearance: none;
            border: none;
        ...
        .volume-bar {
            ...
            min-width: 30px;
            height: 30px;
            background: url("icons/audio-player-icon-sprite.png") 50% center/500% 100% no-repeat;
            position: relative;
        }
        
        .volume-bar.half {
            background: url("icons/audio-player-icon-sprite.png") 75% center/500% 100% no-repeat;
        }
        .volume-bar.over {
            background: url("icons/audio-player-icon-sprite.png") 100% center/500% 100% no-repeat;
        }
